...
def view_graph_for_training_run(savename,**kwargs):
	...
	logger.plot(data_to_plot=["episode_reward", "most_recent_av_test_score", "last_step_reward","episode_durations","memory_size"],**kwargs)
...
view_graph_for_training_run("meta_keep_best_sac_BipedalWalker_256_256_ex3", block=True)
